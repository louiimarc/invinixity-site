...
function writeRuntimePackage() {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      "Mac and the QR uses its .local address for 15 minutes.",
      "They remain in a 24-hour offline queue, appear on Home immediately,",
      "and upload to the public gallery automatically when internet returns.",
